...
class UNetMidBlock2DCrossAttnMusic(nn.Module):
    def __init__(
        ...
        self.adapter = Adapter(in_channels, in_channels, 8, adapter_dim=128, num_heads=8, adapter_type=adapter_type)
...
class CrossAttnDownBlock2DMusic(nn.Module):
    def __init__(
        ...
        self.adapter = Adapter(out_channels, out_channels, 8, adapter_type=adapter_type, num_heads=8)
